...
У ході виконання лабораторної роботи було розроблено класи для роботи з колекціями типу `Collection` та `Map`, реалізовано пошук, фільтрацію, сортування та обробку об'єктів із використанням анонімних класів, лямбда-виразів і посилань на методи. Отримані результати підтверджують ефективність використання Collection Framework для організації та обробки даних у Java.
